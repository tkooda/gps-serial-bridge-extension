...
# Install
You can install an [unpacked zip](https://github.com/tkooda/gps-serial-bridge-extension/releases/download/v1.0.1/gps-serial-bridge-v1.0.1.zip) from the [releases](https://github.com/tkooda/gps-serial-bridge-extension/releases), but Chrome will show you a persistent "Disable developer mode extensions" popup every time you start it.
